...
- Bản **đóng** (`Indicator_high`, `toi_uu_hoa_high`): nguyên lý nội bộ và các tối ưu nâng cao được giữ kín (không nằm trong repo công khai). Liên hệ tác giả để biết chi tiết cấp phép.
